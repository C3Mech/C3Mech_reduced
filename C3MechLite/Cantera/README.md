...
To avoid this, the mechanism files included in the folder define H+O2(+N2)=HO2(+N2) and H+O2(+HE)=HO2(+HE) separately for compilation.
Due to this reason, the numbers of reactions differ between Chemkin and Cantera mechanisms. The reported numbers in the manuscript are for Cantera mechanism.